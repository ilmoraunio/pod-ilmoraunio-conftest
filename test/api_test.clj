...
(deftest parse-test
  (testing "parse"
    (is (= {"test-resources/test.dockerignore" [[{"Value" ".idea", "Original" ".idea", "Kind" "Path"}
            ...
            "test-resources/test.gitignore" [[{"Kind" "Path", "Value" "foo", "Original" "foo"}
                                              {"Value" "bar", "Original" "!bar", "Kind" "NegatedPath"}
                                              {"Kind" "Empty", "Value" "", "Original" ""}
